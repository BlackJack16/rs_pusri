		...
		<section class="content">
			<?php
				...
				switch ($page) {
					...
					case 'act-login': include "../pages/login/act-login-admin.php";break;
					// case 'act-daftar': include "pages/login/act-daftar.php";break;
					// case 'daftar': include "pages/login/form-daftar.php";break;
					 
					default : include '../pages/login/form-login-admin.php';	
				}
			?>
		</section>
	</div>
