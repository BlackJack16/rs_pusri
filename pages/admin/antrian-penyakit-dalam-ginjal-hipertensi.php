<section class="content-header">
   <h1><small></small></h1>
    <ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-th"></i>Antrian Penyakit Dalam Sub Ginjal dan Hipertensi</a></li>
    </ol>
</section>
<?php
	include "dist/koneksi.php";
	
	$DataAntrian =mysql_query("SELECT * FROM `antrianPasien` inner join pasien on antrianPasien.NIK=pasien.NIK inner join dokter on antrianPasien.idDokter=dokter.idDokter WHERE status = 0 and tglAntrian = CURDATE() and dokter.spesialis='Penyakit Dalam Sub Ginjal dan Hipertensi' order by antrianPasien.noAntrian asc limit 1");
	...
	$DataAntrianAll =mysql_query("SELECT * FROM `antrianPasien` inner join pasien on antrianPasien.NIK=pasien.NIK inner join dokter on antrianPasien.idDokter=dokter.idDokter WHERE tglAntrian = CURDATE() and status=0 and dokter.spesialis='Penyakit Dalam Sub Ginjal dan Hipertensi'");
